...
parser.add_argument("--density", default = 0.9, type=float)
parser.add_argument("--gamma", default = 0.01, type=float)
parser.add_argument("--task_name", default =' lm', type=str)
...
# Expert model paths
WIZARDMATH13B_PATH = "vanillaOVO/WizardMath-13B-V1.0"
WIZARDCODER13B_PATH = "WizardLMTeam/WizardCoder-Python-13B-V1.0"
WIZARDLM13B_PATH = "WizardLMTeam/WizardLM-13B-V1.2"
LLAMA2_13B_CODE_ALPACA = "layoric/llama-2-13b-code-alpaca"
