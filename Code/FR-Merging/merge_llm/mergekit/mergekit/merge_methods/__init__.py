...
from mergekit.merge_methods.generalized_task_arithmetic import (
    ...
    GeneralizedTaskArithmeticMergeFourier
)
from mergekit.merge_methods.fourier_merging import MergeFourier
from mergekit.merge_methods.twin_merging import MergeTwin
...
def get(method: str) -> MergeMethod:
    if method == "linear":
        ...
        return GeneralizedTaskArithmeticMergeFourier(
            consensus_method=ConsensusMethod.sum,
            sparsification_method=None,
            default_normalize=False,
            default_rescale=False,
