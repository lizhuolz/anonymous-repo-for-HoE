...
class CustomClassifier(nn.Module):
    def __init__(self, feature_extractor, num_classes):
        ...
        self.classifier = nn.Linear(feature_extractor.config.hidden_size, num_classes)
...
class RouterDataset(Dataset):
    ...
    def __init__(self, data, targets, tokenizer_name='distilbert-base-uncased'):
        self.data = data
...
def train_router(
    ...
    feature_extractor = AutoModel.from_pretrained(model_name).to(device)
