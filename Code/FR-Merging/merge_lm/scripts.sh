...
# models_to_merge+=(./model/lu-vae--roberta-glue/$d/roberta-base_lr1e-05)
models_to_merge+=(./model/vanillaOVO--roberta_base_glue_ckpts/$d/roberta-base_lr1e-05)
# models_to_merge+=(./model/vanillaOVO--roberta_base_glue_ckpts/$d/roberta-base_lr1e-05)
done
...
mask_strategy=${mask_strategy:="top"}
mask_rate=${mask_rate:="0.98"}
