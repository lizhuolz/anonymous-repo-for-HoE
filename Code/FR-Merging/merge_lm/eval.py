...
model_path_template = './model/vanillaOVO--roberta_base_glue_ckpts/{name}/roberta-base_lr1e-05'
head_path_template='./model/lu-vae--roberta-glue/{name}/roberta-base_lr1e-05/classifier_head.pt'
