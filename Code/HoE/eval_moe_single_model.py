...
class ScriptArguments:
    ...
    batch_size: Optional[int] = field(default=7, metadata={"help": "the batch size64"})
...
if dataset_name is None:
    if exp_type == 'assistant':
        ...
        valid_dataset = build_dataset_summary_eval(summary_dataset_path, tokenizer, reward_model.rm_tokenizers, split='test')
...
from mod_utils.My_util_decode_l40 import ConditionedMOEModelWithValueHead
