...
class ScriptArguments:
    ...
    weighting: Optional[str] = field(default="1,0,0")
...
weighting = list(map(float, script_args.weighting.split(",")))
...
for i in range(script_args.num_online_iterations):
    ...
    merged_data, online_dataset = merge_dataset(dataset, online_dataset, checkpoint_path, tokenizer_name, weighting,
